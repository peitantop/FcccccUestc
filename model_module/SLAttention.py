...
if __name__ == '__main__':
    window_size = (12 , 12)  # 注意：设定窗口大小等于输入图片的 H,W
    num_heads = 8  # 注意力头数
    # 创建 SimplifiedLinearAttention 实例
    SLA = SimplifiedLinearAttention(dim=2048, window_size=window_size, num_heads=num_heads)
    ...
    B, L, C = 1, 144, 2048   # 批量大小、序列长度、特征维度
    # 创建一个随机的输入三维张量
